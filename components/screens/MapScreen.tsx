...
const STATIONS: Station[] = [
  { name: 'CC Andino — Chico', address: 'Cl. 82 #11-37, Bogotá', chips: ['AC 22kW', '4 pts', '24h'], busy: false, lng: -74.0527, lat: 4.6664, city: 'Bogotá', dist: '' },
  { name: 'WBC Usaquén', address: 'Cr 6 #119-24, Usaquén', chips: ['DC 50kW', '2 pts'], busy: false, lng: -74.0523, lat: 4.6952, city: 'Bogotá', dist: '' },
  { name: 'Salitre Plaza', address: 'Cr 68B #40-45, Salitre', chips: ['AC 11kW', '6 pts'], busy: true, lng: -74.1058, lat: 4.6567, city: 'Bogotá', dist: '' },
  { name: 'Gran Estación', address: 'Av. Cl. 26 #62-47, Bogotá', chips: ['DC 50kW', 'AC 22kW', '24h'], busy: false, lng: -74.1089, lat: 4.6476, city: 'Bogotá', dist: '' },
  { name: 'CC Santa Fe', address: 'Av. El Dorado #69-71, Bogotá', chips: ['AC 11kW', '3 pts'], busy: false, lng: -74.1129, lat: 4.6583, city: 'Bogotá', dist: '' },
  { name: 'CC El Tesoro', address: 'Cl. 9 Sur #31-111, Medellín', chips: ['DC 50kW', '2 pts', '24h'], busy: false, lng: -75.5673, lat: 6.1772, city: 'Medellín', dist: '' },
  { name: 'Santafé Medellín', address: 'Cl. 27A #43A-50, Medellín', chips: ['AC 22kW', '4 pts'], busy: true, lng: -75.5814, lat: 6.2013, city: 'Medellín', dist: '' },
  { name: 'Jardín Plaza Cali', address: 'Cl. 16 Norte #100-00, Cali', chips: ['DC 50kW', 'AC 11kW'], busy: false, lng: -76.5225, lat: 3.4516, city: 'Cali', dist: '' },
  { name: 'CC Palmetto Cali', address: 'Cr 100 #11-60, Cali', chips: ['AC 22kW', '2 pts'], busy: false, lng: -76.5541, lat: 3.3722, city: 'Cali', dist: '' },
  { name: 'Buenavista Barranquilla', address: 'Cr 53 #98-99, Barranquilla', chips: ['DC 50kW', '2 pts'], busy: false, lng: -74.7936, lat: 11.0041, city: 'Barranquilla', dist: '' },
  { name: 'CC Portal del Prado', address: 'Cr 46 #76-201, Barranquilla', chips: ['AC 11kW', '3 pts'], busy: true, lng: -74.8134, lat: 10.9878, city: 'Barranquilla', dist: '' },
]
